# IIIF-Commons Project Governance

## Core Technical Committee

The IIIF-Commons project is governed by a Core Technical Committee (CTC) which is
...
For the current list of CTC members, see the [Current Members document]().

## Collaborators

The IIIF-Commons and IIIF-Labs GitHub organisations are
...
Modifications of the contents of the IIIF-Commons and IIIF-Labs repositories are made on
...
[MEMBERS.md](./MEMBERS.md#Collaborators).
